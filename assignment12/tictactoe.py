    ...
    def whats_next(self):
        ...
        if not win:
            if self.board_array[1][1] != " ": # check diagonals
                if self.board_array[0][0] == self.board_array[1][1] and self.board_array[1][1] == self.board_array[2][2]:
                    win = True
                if self.board_array[0][2] ==  self.board_array[1][1] and self.board_array[1][1] == self.board_array[2][0]:
                    win = True
        if not win:
            cat = False
